...
//       onTranslated(commentId, translatedText);
//     } catch (error) {
...
//         <Button variant="ghost" size="sm" className="buttons">
...
//               type="button"
//               variant="ghost"
//               className="buttons w-full text-left"
...
//       const res = await axiosInstance.post("/api/translate", {
//         text: commentText,
//         targetLang: "hi", // can be made dynamic
//       });
